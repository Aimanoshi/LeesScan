    ...
    window.addEventListener('load', function () {
        ...
        fetch('https://api.airtable.com/v0/app9SiJUqIxbsSwyi/Begrijpend_Lezen_VRAGEN' + querystring, {
            ...
            .then(json => {
                ...
                for (let i = 0; i < Tonen.length; i++) {
                    Tonen[i].innerHTML = json.records[i].fields.subklasse9;
                    console.log(i)
                }
            })
        ...
        document.getElementById('form').addEventListener('submit', function (e) {
            ...
            if (isValid == false) {
                ...
                setTimeout(()=>{ location.href = "../../www/begrijpend_lezen/begrijpend_lezen_10.html"}, 1000); 
                ...
                console.log(totaal);
                let totaalSum9 = (sum / (totaal.length * 5)) * 100;

                localStorage.setItem('Subklasse9BegrijpendLezen', totaalSum9);
