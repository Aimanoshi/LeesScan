; (function () {
    ...
    let validateForm = function () {
        ...
        let vraag9 = document.querySelectorAll('.form9 > input:checked');
        ...
        let errVraag9 = document.getElementById('errVraag9');
        ...
        if (vraag9.length == 0) {
            isValid = false;
            errVraag9.innerHTML = 'gelieve een cijfer te kiezen';
            errVraag9.style.display = 'block';
        } else {
            errVraag9.style.display = 'none';
    ...
    window.addEventListener('load', function () {
        ...
        document.getElementById('form').addEventListener('submit', function (e) {
            ...
            if (isValid == false) {
                ...
                setTimeout(()=>{ location.href = "../../www/begrijpend_lezen/begrijpend_lezen_3.html"}, 1000); 
                ...
                for (let i = 0; i < vraag6.length; i++) {
                 ...
                 let vraag9 = document.querySelectorAll('input[name ="vraag9"]');
 
                 for (let i = 0; i < vraag9.length; i++) {
                     if (vraag9[i].checked) {
                        keuze9 = vraag9[i].value;
                         if (keuze9 > 0) {
                             totaal.push(keuze9);
                         } else {
                             nul.push(keuze9);
                ...
                localStorage.setItem('Subklasse2BegrijpendLezen', totaalSum2);
