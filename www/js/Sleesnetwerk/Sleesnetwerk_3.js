; (function () {
    ...
    window.addEventListener('load', function () {
        ...
        fetch('https://api.airtable.com/v0/app9SiJUqIxbsSwyi/SLeesnetwerk_VRAGEN' + querystring, {
            headers: {
        ...
        document.getElementById('form').addEventListener('submit', function (e) {
            ...
            if (isValid == false) {
                ...
                setTimeout(() => { location.href = "../../www/Stussenpagina.html" }, 1000);
                ...
                localStorage.setItem('Subklasse3SLeesnetwerk', totaalSum3);

                // totaal bereken van alle sub klasse
                let TotaalSubklasse = [];


                let subklasse1 = localStorage.getItem('Subklasse3SLeesnetwerk');
                TotaalSubklasse.push(subklasse1);

                let subklasse2 = localStorage.getItem('Subklasse3SLeesnetwerk');
                TotaalSubklasse.push(subklasse2);

                let subklasse3 = localStorage.getItem('Subklasse3SLeesnetwerk');
                ...
                fetch('https://api.airtable.com/v0/app9SiJUqIxbsSwyi/SLeesnetwerk_ANTWOORD', {
                    method: 'POST',
                    headers: {
                    ...
                    .then(json => {
                        console.log(json)
                        localStorage.setItem('Svragenlijst1', json.records[0].id);
                    }
