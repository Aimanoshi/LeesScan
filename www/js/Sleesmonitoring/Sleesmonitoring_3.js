    ...
    window.addEventListener('load', function () {
        ...
        document.getElementById('form').addEventListener('submit', function (e) {
            ...
            if (isValid == false) {
                ...
                localStorage.setItem('Subklasse3SLeesmonitoring', totaalSum3);

                // totaal bereken van alle sub klasse
                let TotaalSubklasse = [];


                let subklasse1 = localStorage.getItem('Subklasse1SLeesmonitoring');
                TotaalSubklasse.push(subklasse1);

                let subklasse2 = localStorage.getItem('Subklasse2SLeesmonitoring');
                TotaalSubklasse.push(subklasse2);

                let subklasse3 = localStorage.getItem('Subklasse3SLeesmonitoring');
                ...
                fetch('https://api.airtable.com/v0/app9SiJUqIxbsSwyi/SLeesmonitoring_ANTWOORD', {
                    method: 'POST',
                    headers: {
                        'Authorization': 'Bearer keybe7D1M6i7oaWj6',
                    ...
                    .then(json => {
                        console.log(json)
                        localStorage.setItem('Svragenlijst3', json.records[0].id);
                    }
